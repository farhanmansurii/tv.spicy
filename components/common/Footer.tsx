...
const MinimalSocialsFooter = () => {
    return (
        <div className="flex max-w-3xl   text-[12px] w-full mx-auto flex-col items-start justify-between gap-3 rounded-xl py-10   mt-[4rem]">
           <Separator/>
            <div className="px-3">
                Disclaimer!
                This site does not store any files on our server, we only linked to the media which is hosted on 3rd party services.
                Dont forget to clear your browser histories before you die.
            </div>
            <div className="flex px-3 flex-row gap-4 items-center">
