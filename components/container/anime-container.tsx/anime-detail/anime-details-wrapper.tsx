...
const AnimeEpisodesContainer = dynamic(() => import('./anime-episodes-container'), {
	ssr: true,
...
export default function AnimeDetailsWrapper({ anime }: { anime: Anime }) {
	...
	return (
		<div className="max-w-6xl w-full space-y-10  mx-auto">
			...
			<Separator className="max-w-7xl w-full  mx-auto" />
			<AnimeEpisodesContainer id={anime.id} />
			<Separator className="max-w-7xl w-full  mx-auto" />
			<MoreDetailsContainer type={'anime'} show={anime} renderContent={renderContent} />
