...
function UserWatchlistTVComponent() {
	const { data: watchlist = [], isLoading } = useUserWatchlist('tv');
...
export const UserWatchlistTV = memo(UserWatchlistTVComponent);
UserWatchlistTV.displayName = 'UserWatchlistTV';
