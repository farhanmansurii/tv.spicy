					...
					{imageUrl ? (
						...
						>
							<img
								src={imageUrl}
								alt=""
								className="w-full h-full object-cover transition-transform duration-900 supports-[hover:hover]:group-hover:scale-[1.045] supports-[hover:hover]:group-hover:brightness-110"
