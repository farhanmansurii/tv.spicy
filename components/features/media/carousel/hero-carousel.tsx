		...
		>
			...
			>
				...
				<div className="hidden md:flex absolute right-12 bottom-12 z-20 gap-3">
					<CarouselPrevious
						variant="ghost"
						className="static translate-y-0 h-12 w-12 rounded-full border-white/10 bg-black/40 hover:bg-white/10 text-white backdrop-blur-md transition-all duration-300 will-change-transform"
					/>
					<CarouselNext
						variant="ghost"
						className="static translate-y-0 h-12 w-12 rounded-full border-white/10 bg-black/40 hover:bg-white/10 text-white backdrop-blur-md transition-all duration-300 will-change-transform"
