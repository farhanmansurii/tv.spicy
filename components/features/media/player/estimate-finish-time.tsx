...
const EstimateFinishTime = ({ runtime }: { runtime: any }) => {
	...
	return (
		<div className="font-bold">
			Estimated Finish Time: <span className="font-normal">{estimatedFinishTime}</span>
		</div>
	);
};
...
export default EstimateFinishTime;
