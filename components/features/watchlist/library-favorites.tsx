        ...
        <div className="space-y-10">
            ...
            {movieFavorites.length > 0 && (
                <div className="space-y-6">
                    <div>
                        <h3 className="text-lg md:text-xl font-semibold text-foreground mb-1">Favorite Movies</h3>
            ...
            {tvFavorites.length > 0 && (
                <div className="space-y-6">
                    <div>
                        <h3 className="text-lg md:text-xl font-semibold text-foreground mb-1">Favorite TV Shows</h3>
