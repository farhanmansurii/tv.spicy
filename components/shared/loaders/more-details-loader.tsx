			...
			<div className="space-y-2 sm:space-y-3">
				...
				<CommonTitle text="More Like This" variant="small" spacing="large">
					<div className="flex items-center p-1 bg-white/[0.03] border border-white/[0.08] rounded-full backdrop-blur-3xl shadow-2xl">
						<button className="relative px-5 md:px-7 py-2.5 text-[10px] md:text-xs font-black uppercase tracking-widest transition-all duration-300 outline-none z-10 rounded-full text-black shadow-lg">
						...
						<button className="relative px-5 md:px-7 py-2.5 text-[10px] md:text-xs font-black uppercase tracking-widest transition-all duration-300 outline-none z-10 rounded-full text-zinc-400 hover:text-white">
