...
export default function CommandPalette({
	...
	const searchTerm =
		controlledSearchValue !== undefined ? controlledSearchValue : internalSearchTerm;
											...
											<div className="flex items-start gap-2">
												...
												<div className="text-xs">
													...
													<ul className="mt-1 space-y-1 text-[#181818]/70 dark:text-[#f2f2f2]/70">
														...
														<li>
															• Can you explain how the command
															palette works?
														</li>
														<li>
															• Generate a color scheme for my website
														</li>
													</ul>
												</div>
											</div>
