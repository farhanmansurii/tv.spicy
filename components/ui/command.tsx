...
>(({ className, ...props }, ref) => (
  <div className="flex items-center px-5 h-14 w-full border-b border-border/50" cmdk-input-wrapper="">
    <Search className="mr-3 h-5 w-5 shrink-0 text-foreground/40" />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className={cn(
      "py-12 text-center text-sm text-foreground/60",
      className
    )}
    {...props}
  />
